...
function Public.initial_setup()
    ...
    local defs = {
        defines.input_action.activate_copy, defines.input_action.activate_cut, defines.input_action.activate_paste,
        defines.input_action.change_active_quick_bar, defines.input_action.clear_cursor,
        defines.input_action.edit_permission_group, defines.input_action.gui_click, defines.input_action.gui_confirmed,
        defines.input_action.gui_elem_changed, defines.input_action.gui_location_changed,
        defines.input_action.gui_selected_tab_changed, defines.input_action.gui_selection_state_changed,
        defines.input_action.gui_switch_state_changed, defines.input_action.gui_text_changed,
        defines.input_action.gui_value_changed, defines.input_action.open_character_gui,
        defines.input_action.open_kills_gui, defines.input_action.quick_bar_set_selected_page,
        defines.input_action.quick_bar_set_slot, defines.input_action.rotate_entity, defines.input_action.set_filter,
        defines.input_action.set_player_color, defines.input_action.start_walking,
    ...
    for chunk in surface.get_chunks() do surface.delete_chunk({chunk.x, chunk.y}) end
end
...
function Public.playground_surface()
    ...
    map_gen_settings.autoplace_controls = {
        ...
        ['trees'] = {
            frequency = math.random(8, 28) * 0.1, size = math.random(6, 14) * 0.1, richness = math.random(2, 4) * 0.1,
...
function Public.tables()
    ...
    global.biter_spawn_unseen = {
        ['north'] = {
            ['medium-spitter'] = true, ['medium-biter'] = true, ['big-spitter'] = true, ['big-biter'] = true,
            ['behemoth-spitter'] = true, ['behemoth-biter'] = true,
        }, ['south'] = {
            ['medium-spitter'] = true, ['medium-biter'] = true, ['big-spitter'] = true, ['big-biter'] = true,
            ['behemoth-spitter'] = true, ['behemoth-biter'] = true,
        },
