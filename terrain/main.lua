...
function Terrain.draw_structures()
    ...
    clear_ore_in_main(surface, defines.direction.southwest)
    clear_ore_in_main(surface, defines.direction.northwest)
    clear_ore_in_main(surface, defines.direction.east)
    generate_spawn_ore(surface, nil, defines.direction.southwest)
